...
export default function DashboardPage() {
  ...
  const loadStats = async () => {
    try {
      ...
      const videosSize =
        vData.files?.reduce((acc: number, f: any) => acc + f.size, 0) || 0;
      const audiosSize =
        aData.files?.reduce((acc: number, f: any) => acc + f.size, 0) || 0;
      const csvSize =
        cData.files?.reduce((acc: number, f: any) => acc + f.size, 0) || 0;
        ...
        <div className="lg:col-span-3 space-y-6">
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div
                ...
                className="w-full"
              >
                <Link className="block w-full" href="/dashboard/videos">
                  <Card
                    isHoverable
                    isPressable
              ...
              <div
                ...
                className="w-full"
              >
                <Link className="block w-full" href="/dashboard/audios">
                  <Card
                    isHoverable
                    isPressable
                    className="transition-all hover:shadow-md w-full"
              ...
              <div
                ...
                className="w-full"
              >
                <Link className="block w-full" href="/dashboard/texts">
                  <Card
                    isHoverable
                    isPressable
                    className="transition-all hover:shadow-md w-full"
          ...
          <div ref={actionsRef}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link className="block w-full" href="/dashboard/create">
                <Card
                  isHoverable
                  isPressable
                  className="transition-all hover:shadow-md w-full"
                >
                  <CardBody className="flex-row items-center justify-between p-4">
                    ...
                    <ArrowRight className="text-default-400" size={16} />
                  </CardBody>
                </Card>
              </Link>

              <Link className="block w-full" href="/dashboard/projects">
                <Card
                  isHoverable
                  isPressable
                  className="transition-all hover:shadow-md w-full"
          ...
          <div ref={viralRef}>
            ...
            <div className="grid grid-cols-3 gap-3">
              <Link
                ...
                href="/dashboard/community?filter=viral-audios"
              >
                <Card
                  isHoverable
                  isPressable
              ...
              <Link
                className="block w-full"
                href="/dashboard/community?filter=viral-texts"
              >
                <Card
                  isHoverable
                  isPressable
              ...
              <Link
                className="block w-full"
                href="/dashboard/community?filter=model-videos"
              >
                <Card
                  isHoverable
                  isPressable
          ...
          <div ref={generateRef}>
            ...
            <div className="grid grid-cols-1 gap-3">
              <Link className="block w-full" href="/dashboard/image-to-video">
                <Card
                  isHoverable
                  isPressable
                  className="transition-all hover:shadow-md w-full"
                  ...
                  <CardBody className="flex-row items-center justify-between p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-default-500">
                          Convert images to videos with AI
                        </p>
                      </div>
                    </div>
                    <ArrowRight className="text-default-400" size={16} />
              ...
              <CardBody className="gap-3 pt-3">
                <div>
                  <p className="text-sm font-semibold mb-1">
                    Projects Auto-Cleanup
                  </p>
                  <p className="text-xs text-default-500 mb-2">
                    Projects are automatically deleted after 24 hours to save
                    storage space.
                  </p>
                  <div className="flex items-center gap-2 text-xs">
                    <Folder className="text-default-400" size={14} />
